"""
URL configuration for infoCidadao project.
...
from usuario.views import RegistroUsuarioView, LoginUsuarioView
from postagem.views import PostagemViewSet, CurtidaViewSet , ComentarioViewSet
